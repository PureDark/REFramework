...
public:
    ...
    std::string_view get_name() const override { return "RE4VR"; }
...
private:
    ...
    bool lua_is_true(std::string_view name);
    bool lua_not_false(std::string_view name);
    std::optional<double> lua_number(std::string_view name);
    std::optional<std::string> lua_string(std::string_view name);
    void lua_set_bool(std::string_view name, bool v);
    void lua_set_number(std::string_view name, double v);
    void lua_set_string(std::string_view name, std::string_view v);
    void lua_set_nil(std::string_view name);
