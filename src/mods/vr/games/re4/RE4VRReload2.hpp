...
class RE4VRReload2 : public Mod {
public:
    static std::shared_ptr<RE4VRReload2>& get();
    std::string_view get_name() const override { return "RE4VRReload2"; }
    ...
    static HookManager::PreHookResult pre_xbow_dummy(std::vector<uintptr_t>& args, std::vector<sdk::RETypeDefinition*>& arg_tys, uintptr_t ret_addr);
